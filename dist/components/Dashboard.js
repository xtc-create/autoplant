...
function Dashboard() {
    ...
    return ((0, jsx_runtime_1.jsxs)("main", { className: "dashboard", style: cssVars, children: [(0, jsx_runtime_1.jsx)("style", { children: `
      ...
      ` }), (0, jsx_runtime_1.jsxs)("div", { className: "dashboard-shell", children: [isDry && !alertDismissed && ((0, jsx_runtime_1.jsxs)("div", { className: "alert", children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Soil is dry" }), " - moisture at ", fmt(latest?.moisture, 0), "%. Water your plant."] }), (0, jsx_runtime_1.jsx)("button", { className: "dismiss", type: "button", onClick: () => setDismissed(true), "aria-label": "Dismiss alert", children: "x" })] })), (0, jsx_runtime_1.jsxs)("header", { className: "topbar", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h1", { children: "AutoPlant" }), (0, jsx_runtime_1.jsx)("p", { className: "sync", children: loading && !lastFetch ? "connecting..." : lastFetch ? `synced ${lastFetch.toLocaleTimeString()}` : "-" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "actions", children: [(0, jsx_runtime_1.jsxs)("label", { className: "auto-toggle", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: autoRefresh, onChange: (e) => setAuto(e.target.checked) }), "auto 30s"] }), (0, jsx_runtime_1.jsx)("button", { className: "icon-button", type: "button", onClick: () => setDark((value) => !value), "aria-label": "Toggle theme", children: dark ? "L" : "D" }), (0, jsx_runtime_1.jsx)("button", { className: `text-button ${csvFlash ? "exported" : ""}`, type: "button", onClick: handleCSV, disabled: !data.length, children: csvFlash ? "exported" : "CSV" }), (0, jsx_runtime_1.jsx)("button", { className: "primary-button", type: "button", onClick: fetchData, disabled: loading, children: loading ? "syncing" : "refresh" })] })] }), error && (0, jsx_runtime_1.jsxs)("div", { className: "error", children: [error, " - server may be waking up, try refreshing."] }), (0, jsx_runtime_1.jsx)("section", { className: "metrics", "aria-label": "Latest readings", children: [
                            ...
                            { label: "readings", value: String(data.length || "-"), unit: "", color: "#16a34a" },
                        ].map(({ label, value, unit, color, badge }) => ((0, jsx_runtime_1.jsxs)("article", { className: "metric", children: [(0, jsx_runtime_1.jsx)("p", { className: "metric-label", children: label }), (0, jsx_runtime_1.jsxs)("div", { className: "metric-value", children: [(0, jsx_runtime_1.jsx)("span", { className: "metric-number", style: { color }, children: value }), unit && (0, jsx_runtime_1.jsx)("span", { className: "metric-unit", children: unit })] }), badge && ((0, jsx_runtime_1.jsxs)("div", { className: "badge", style: { background: sstyle.bg, color: sstyle.color }, children: [(0, jsx_runtime_1.jsx)("span", { className: "dot", style: { background: sstyle.dot } }), (0, jsx_runtime_1.jsx)("span", { children: types_1.MOISTURE_LABELS[status] })] }))] }, label))) }), (0, jsx_runtime_1.jsx)(SensorChart, { data: data, metric: chartMetric, onMetricChange: setChartMetric, dark: dark }), data.length > 0 && ((0, jsx_runtime_1.jsxs)("section", { className: "panel table-panel", children: [(0, jsx_runtime_1.jsxs)("div", { className: "panel-header", children: [(0, jsx_runtime_1.jsx)("span", { className: "eyebrow", children: "Readings log" }), (0, jsx_runtime_1.jsxs)("span", { className: "sync", children: [data.length, " total"] })] }), (0, jsx_runtime_1.jsx)("div", { className: "table-wrap", children: (0, jsx_runtime_1.jsxs)("table", { children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsx)("tr", { children: ["timestamp", "temp C", "humidity %", "soil"].map((header) => ((0, jsx_runtime_1.jsx)("th", { children: header }, header))) }) }), (0, jsx_runtime_1.jsx)("tbody", { children: rows.map((row) => {
                                            ...
                                            }) })] }) }), data.length > 15 && ((0, jsx_runtime_1.jsx)("div", { className: "show-row", children: (0, jsx_runtime_1.jsx)("button", { className: "text-button", type: "button", onClick: () => setShowAll((value) => !value), children: showAll ? "show less" : `show all ${data.length} readings` }) }))] })), !loading && !data.length && !error && ((0, jsx_runtime_1.jsx)("div", { className: "empty-state", children: "No readings yet. Press measure on the ESP32." }))] })] }));
}
